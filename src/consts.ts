...
export const SITE_TITLE = "Nishanth's Blogs";
export const SITE_DESCRIPTION = "Nishanth's Blogs — personal branding and engineering articles by Nishanth Muruganantham.";
